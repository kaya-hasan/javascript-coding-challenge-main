...
2. Print a string to the console containing the bill value, the tip, and the final calue (bill + tip). Example: 'The bill was 275, the tip was 41.25', and the total value 316.25'
...
const stevenBill2 = 40;
const stevenBill3 = 430;
...
printResult(stevenBill1);
printResult(stevenBill2);
printResult(stevenBill3);